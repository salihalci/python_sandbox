...
(51,"Compamy plans to Cache Redis and cacne redis modules? Which service tier is compatible?","Enterprise Redis modules are only supported in the Enterprise service tier. The Basic, Standard, and Premium service tiers do not support Redis modules.")
]
